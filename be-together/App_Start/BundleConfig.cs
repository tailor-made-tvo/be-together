...
namespace TMS.be_together
{
    public static class BundleConfig
    {
        ...
        private static void AddCss(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include("~/Content/bootstrap/site.css",
                "~/Content/fontawesome/site.css", "~/Content/site.css"));
        }
        ...
        private static void AddJavaScript(BundleCollection bundles)
        {
            ...
            Bundle jqueryBundle =
                new ScriptBundle("~/bundles/jquery", ContentDeliveryNetwork.Google.JQueryUrl).Include(
                    "~/Scripts/jquery-{version}.js");
            bundles.Add(jqueryBundle);

            // jQuery Validate - Client side JavaScript form validation (http://jqueryvalidation.org/).
            Bundle jqueryValidateBundle =
                new ScriptBundle("~/bundles/jqueryval", ContentDeliveryNetwork.Microsoft.JQueryValidateUrl).Include(
            ...
            Bundle jqueryValidateUnobtrusiveBundle =
                new ScriptBundle("~/bundles/jqueryvalunobtrusive",
                    ContentDeliveryNetwork.Microsoft.JQueryValidateUnobtrusiveUrl).Include("~/Scripts/jquery.validate*");
            ...
            Bundle modernizrBundle = new ScriptBundle("~/bundles/modernizr")
            ...
            Bundle bootstrapBundle =
                new ScriptBundle("~/bundles/bootstrap", ContentDeliveryNetwork.Microsoft.BootstrapUrl).Include(
            ...
            Bundle respondBundle =
                new ScriptBundle("~/bundles/respond", ContentDeliveryNetwork.Microsoft.RespondUrl).Include(
                    "~/Scripts/respond.js");
            bundles.Add(respondBundle);


            // Failover Core - If the CDN's fail then these scripts load local copies of the same scripts.
            Bundle failoverCoreBundle =
                new ScriptBundle("~/bundles/failovercore").Include("~/Scripts/Failover/jquery.js")
            ...
            Bundle failoverRespondBundle =
                new ScriptBundle("~/bundles/failoverrespond").Include("~/Scripts/Failover/respond.js");
