...
namespace TMS.be_together
{
    public static class FilterConfig
    {
        ...
        ///     <see
        ///         cref="http://nwebsec.codeplex.com/wikipage?title=Configuring%20Content%20Security%20Policy&referringTitle=NWebsec.Mvc" />
        ///     and
        ///     <see cref="https://developer.mozilla.org/en-US/docs/Web/Security/CSP/CSP_policy_directives" /> for more
        ///     information).
...
// Allow scripts from the CDN's.
                CustomSources =
                    string.Format("{0} {1}", ContentDeliveryNetwork.Google.Domain,
