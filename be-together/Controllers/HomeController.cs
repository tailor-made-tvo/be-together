...
namespace TMS.be_together.Controllers
{
    public class HomeController : Controller
    {
        ...
        //[Route("login", Name = HomeControllerRoute.GetLoginPartial)]
        //public ActionResult LoginPartial()
        //{
        //    return this.View(HomeControllerAction.LoginPartial);
        //}
        ...
        {
            Trace.WriteLine(string.Format("robots.txt requested. User Agent:<{0}>.",
            ...
            return this.Content(stringBuilder.ToString(), ContentType.Text, Encoding.UTF8);
        }
        ...
        {
            Trace.WriteLine(string.Format("sitemap.xml requested. User Agent:<{0}>.",
                this.Request.Headers.Get("User-Agent")));
